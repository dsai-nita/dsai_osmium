...
Menu : ({ className = "", size = 24 }: IconProps) => (
  ...
  Twitter: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M6.124 4h4.267l11.733 16h-4.267z"/>
    </svg>
  ),

  Instagram: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Youtube: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  // Additional icons needed for the components
  ...
  LogIn: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M9 21v-6a2 2 0 0 1 2-2h7"/>
      <path d="M3 12h11"/>
    </svg>
  ),
  ...
  UserPlus: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  MessageCircle: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Bot: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Minimize2: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Maximize2: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Trophy: ({ className = "", size = 24 }: IconProps) => (
    ...
    >
      ...
      <path d="M4 22h16"/>
      <path d="M10 14.66V17c0 .55.47.98.97 1.21C12.15 18.75 14 20 16 20s4-1.25 5.03-1.79c.5-.23.97-.66.97-1.21v-2.34c0-1.06-.43-2.08-1.19-2.83l-1.75-1.75a2 2 0 0 0-1.41-.59H9.35a2 2 0 0 0-1.41.59L6.19 11.83A4.01 4.01 0 0 0 5 14.66Z"/>
    </svg>
  ),
  ...
  Activity: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      ...
      className={className}
    >
      <path d="m22 12-8.5-8.5L9 8l-7 7"/>
      <path d="m16 16 6-6"/>
      <path d="m6 16 6-6"/>
    </svg>
  ),

  BookOpen: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  LogOut: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Timer: ({ className = "", size = 24 }: IconProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
